...
class MascotasGridGestion extends StatefulWidget {
  const MascotasGridGestion({
    Key? key,
    required this.uid,
  ...
  @override
  _MascotasGridGestionState createState() => _MascotasGridGestionState();
}

class _MascotasGridGestionState extends State<MascotasGridGestion> {
